  ...
  return (
   ...
   return (
     ...
     <Student record={record} dateFormat={dateFormat} />
          ...
          //           <button id="showMoreBtn" onClick={() => setShowMore(!showMore)}>
          //             {" "}
          ...
          //                       Assignments:{" "}
          //                       <span>
          //                         {record.cohort.scores.assignments * 100}%
          //                       </span>
          //                     </p>
          //                     <p>
          //                       Projects:{" "}
          //                       <span>
          //                         {record.cohort.scores.projects * 100}%
          //                       </span>
          //                     </p>
          //                     <p>
          //                       Assessments:{" "}
          //                       <span>
          //                         {record.cohort.scores.assessments * 100}%
          //                       </span>
          //                     </p>
          //                   </article>
          //                 </section>
